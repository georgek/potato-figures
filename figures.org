...
#+INCLUDE: "~/work/potato/scripts/sam-to-R.py" src python
...
#+INCLUDE: "~/work/potato/scripts/homopolymers.py" src python
...
#+INCLUDE: "~/work/potato/scripts/bac-graphs2.R" src R
