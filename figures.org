...
and a GC content and homopolymer track.

** Contig alignment

For the contig alignments we used bwa-mem.

** Read alignment

For the read alignment we use bowtie2.
...
#+BEGIN_SRC sh :results output verbatim raw :exports both :cache yes :var i=90 :var l=10000 :var table=synteny-names :separator ,
  IFS=','
  while read name filename; do
...
#+RESULTS[5fa0bc5cb98b421f3d61ebce71a288ff79ca73d2]:
Supernova + BioNano
